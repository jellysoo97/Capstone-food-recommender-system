...
#레시피 정보
df_recipes = pd.read_csv('/content/drive/MyDrive/Colab Notebooks/레시피기본정보_취합_2.csv')
#각 레시피 마다 필요한 재료 정보
df_igrds = pd.read_csv('/content/drive/MyDrive/Colab Notebooks/재료리스트정리.csv')
#유저 평점 정보
